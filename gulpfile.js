...
gulp.task('img:build', function() {
    return gulp.src('src/static/imgs/**/*.{png,jpeg,jpg,gif}')
...
gulp.task('svg', function() {
    return gulp.src('src/static/imgs/svg/**/*.svg')
        .pipe(gp.svgmin({
            js2svg: {
                pretty: true
            }
...
gulp.task('default', gulp.series(
    'clean',
    gulp.parallel('pug', 'scss', 'scripts:lib', 'scripts', 'img:dev', 'svg', 'fonts'),
    gulp.parallel('watch', 'serve')
));

gulp.task('build', gulp.series(
    'clean',
    gulp.parallel('pug', 'scss', 'scripts:lib', 'scripts', 'img:build', 'svg', 'fonts'),
    gulp.parallel('watch', 'serve')
));